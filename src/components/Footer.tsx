...
const Footer = () => {
  ...
  return (
    <footer className="bg-neutral-800 text-white pt-8 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@aimentalhealth.org" className="hover:text-blue-400 transition-colors">info@aimentalhealth.org</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>Línea de ayuda: (123) 456-7890</span>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/recursos/ansiedad" className="hover:text-blue-400 transition-colors">
                  Manejo de la ansiedad
                </Link>
              </li>
              <li>
                <Link href="/recursos/depresion" className="hover:text-blue-400 transition-colors">
                  Sobre la depresión
                </Link>
              </li>
              <li>
                <Link href="/recursos/tecnicas" className="hover:text-blue-400 transition-colors">
                  Técnicas de relajación
                </Link>
              </li>
              <li>
                <Link href="/recursos/crisis" className="hover:text-blue-400 transition-colors">
                  Manejo de crisis
                </Link>
              </li>
              <li>
                <Link href="/recursos/profesionales" className="hover:text-blue-400 transition-colors">
        ...
        <div className="border-t border-neutral-700 mt-8 pt-6 text-center text-sm text-neutral-400">
          <p>
            &copy; {currentYear} AI Mental Health. Esta herramienta no sustituye la atención profesional.
          </p>
          <p className="mt-2">
            En caso de emergencia, contacta con servicios de emergencia locales o acude al centro médico más cercano.
          </p>
        </div>
      </div>
    </footer>
